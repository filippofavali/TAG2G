...
if __name__ == '__main__':
    ...
    # print(f"project root: {project_root}")                                    # Debug line - check project scope
    ...
    save_vqvae_features(Path(os.path.join(project_root, args.src)), Path(args.dst), args.speaker_motion)
